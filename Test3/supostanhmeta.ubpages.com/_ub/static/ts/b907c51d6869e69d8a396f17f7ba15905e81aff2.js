/*! For license information please see tracker.js.LICENSE.txt */ ! function() {
    var n = {
        366: function(n) {
            var e = {
                utf8: {
        ...
        843: function(n) {
            var e, t;
            e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", t = {
                rotl: function(n, e) {
                    return n << e | n >>> 32 - e
                },
                rotr: function(n, e) {
                ...
                bytesToWords: function(n) {
                    for (var e = [], t = 0, r = 0; t < n.length; t++, r += 8) e[r >>> 5] |= n[t] << 24 - r % 32;
                    return e
                },
                ...
                bytesToBase64: function(n) {
                    for (var t = [], r = 0; r < n.length; r += 3)
                        for (var o = n[r] << 16 | n[r + 1] << 8 | n[r + 2], i = 0; i < 4; i++) 8 * r + 6 * i <= 8 * n.length ? t.push(e.charAt(o >>> 6 * (3 - i) & 63)) : t.push("=");
                    return t.join("")
                },
        ...
        363: function(n, e, t) {
            var r, o, i, a;
            r = t(843), o = t(366).utf8, i = t(366).bin, (a = function(n, e) {
            ...
            })._blocksize = 16, a._digestsize = 20, n.exports = a
        },
        972: function(n, e, t) {
            var r = t(679),
                o = t(161),
                i = o;
            i.v1 = r, i.v4 = o, n.exports = i
        },
        318: function(n) {
        ...
        42: function(n) {
            ...
            if (e) {
                ...
                var r = new Array(16);
                n.exports = function() {
                    for (var n, e = 0; e < 16; e++) 0 == (3 & e) && (n = 4294967296 * Math.random()), r[e] = n >>> ((3 & e) << 3) & 255;
                    return r
                }
            }
        },
        679: function(n, e, t) {
            ...
            n.exports = function(n, e, t) {
                ...
                var p = void 0 !== n.msecs ? n.msecs : (new Date).getTime(),
                    ...
                    m = p - c + (g - u) / 1e4;
                if (m < 0 && void 0 === n.clockseq && (d = d + 1 & 16383), (m < 0 || p > c) && void 0 === n.nsecs && (g = 0), g >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
                c = p, u = g, o = d;
    ...
    function() {
        ...
        function i() {
            ...
            return {
                add: i,
                addDict: function(n) {
                    for (var e in n) Object.prototype.hasOwnProperty.call(n, e) && i(e, n[e])
                },
            ...
            return function(t, r, i) {
                for (var a = function(e, r, i) {
                        ...
                        n ? t.add(r, (a = c) ? function(n) {
                            ...
                            do {
                                e = (a = n.charCodeAt(c++) << 16 | n.charCodeAt(c++) << 8 | n.charCodeAt(c++)) >> 18 & 63, t = a >> 12 & 63, r = a >> 6 & 63, i = 63 & a, s[u++] = o.charAt(e) + o.charAt(t) + o.charAt(r) + o.charAt(i)
                            } while (c < n.length);
                            var l = s.join(""),
                                f = n.length % 3;
                        ...
                        var i = e || function() {
                            var e = t.getPayload();
                            if (n ? e.cx : e.co) return JSON.parse(n ? function(n) {
                                if (!n) return n;
                                switch (4 - n.length % 4) {
                                    case 2:
                                        n += "==";
                                ...
                                return function(n) {
                                    var e, t, r, i, a, c, u, s = 0,
                                        l = 0,
                                        f = [];
                                    if (!n) return n;
                                    n += "";
                                    do {
                                        e = (c = o.indexOf(n.charAt(s++)) << 18 | o.indexOf(n.charAt(s++)) << 12 | (i = o.indexOf(n.charAt(s++))) << 6 | (a = o.indexOf(n.charAt(s++)))) >> 16 & 255, t = c >> 8 & 255, r = 255 & c, f[l++] = 64 === i ? String.fromCharCode(e) : 64 === a ? String.fromCharCode(e, t) : String.fromCharCode(e, t, r)
                                    } while (s < n.length);
                                    return u = f.join("").replace(/\0+$/, ""), decodeURIComponent(u.split("").map((function(n) {
                                        return "%" + ("00" + n.charCodeAt(0).toString(16)).slice(-2)
                                    })).join(""))
                                }(n.replace(/-/g, "+").replace(/_/g, "/"))
                            }(e.cx) : e.co)
                        }();
                        return i ? i.data = i.data.concat(r.data) : i = r, i
                    }, u = void 0, s = 0, l = r; s < l.length; s++) {
                    var f = l[s];
                    "cx" === f.keyIfEncoded ? u = c(u, f.json) : a(f.json, f.keyIfEncoded, f.keyIfNotEncoded)
                }
                r.length = 0, i.length && (u = c(u, {
                    schema: "iglu:com.snowplowanalytics.snowplow/contexts/jsonschema/1-0-0",
                    data: e([], i, !0)
                }), i.length = 0), u && a(u, "cx", "co")
            }
        }
        ...
        var s, l = "Snowplow: ";
        ! function(n) {
            n[n.none = 0] = "none", n[n.error = 1] = "error", n[n.warn = 2] = "warn", n[n.debug = 3] = "debug", n[n.info = 4] = "info"
        }(s || (s = {}));
                                    ...
                                    if (k(n)) {
                                        ...
                                        if (!0 === i) return I(n[1], e, t, r)
                                            ...
                                            return Array.isArray(i) ? n.reject.some((function(n) {
                                                return T(n, e)
                                            })) && t++ : "string" == typeof i && T(i, e) && t++, r > 0 && 0 === t
                                        }(n[0], r)) return I(n[1], e, t, r);
                                    return []
                                }(n, e, t, r);
        ...
        function g(n) {
            ...
            if (null !== e && p(e[1])) return e.slice(1, 6)
        }
        ...
        function E(n, e) {
            void 0 === e && (e = {});
            var t = {};
            for (var r in n)(e[r] || null !== n[r] && void 0 !== n[r]) && (t[r] = n[r]);
            return t
        }
        var j = t(363),
            L = t.n(j);
        ...
        function D(n, e, t) {
            ...
            try {
                var r = window.localStorage,
                    o = Date.now() + 1e3 * t;
                return r.setItem("".concat(n, ".expires"), o.toString()), r.setItem(n, e), !0
            } catch (n) {
                return !1
            }
        }
        ...
        function B(n) {
            try {
                ...
                return e.removeItem(n), e.removeItem(n + ".expires"), !0
            } catch (n) {
                return !1
            }
        }
        ...
        function V(n) {
            var e = n.length;
            return "." === n.charAt(--e) && (n = n.slice(0, e)), "*." === n.slice(0, 2) && (n = n.slice(1)), n
        }
        ...
        function H(n, e, t, r) {
            return n.addEventListener ? (n.addEventListener(e, t, r), !0) : n.attachEvent ? n.attachEvent("on" + e, t) : void(n["on" + e] = t)
        }
        ...
        function G(n) {
            for (var e = document.cookie.split("; "), t = [], r = 0; r < e.length; r++) e[r].substring(0, n.length) === n && t.push(e[r]);
            return t
        }
        ...
        function X(n) {
            if (null == n || "object" != typeof n || Array.isArray(n)) return function() {
                return !0
            };
        ...
        function K(n, e, t, r, o, i, a, c, u, s, l, f, v, p, g, m, h) {
            var y, w, b = !1,
                k = [],
                S = !1,
                x = !0 === (r = "string" == typeof r ? r.toLowerCase() : r) || "beacon" === r || "true" === r,
                T = Boolean(x && window.navigator && window.navigator.sendBeacon && !(function(n, e) {
                ...
                I = !C && O && ("post" === r || x),
                A = I ? o : "/i",
                P = "snowplowOutQueue_".concat(n, "_").concat(I ? "post2" : "get");
            if (x && (v = {}), i = t && function() {
                    var n = "modernizr";
                    if (! function() {
                            try {
            ...
            function L(n) {
                for (var e = 0, t = 0; t < n.length; t++) {
                    ...
                    r <= 127 ? e += 1 : r <= 2047 ? e += 2 : r >= 55296 && r <= 57343 ? (e += 4, t++) : e += r < 65535 ? 3 : 4
                }
                return e
            }
            Array.isArray(k) || (k = []), e.outQueues.push(k), O && i > 1 && e.bufferFlushers.push((function(n) {
                b || U(n)
            }));
            var B = function(n) {
            ...
            function U(n) {
                for (void 0 === n && (n = !1); k.length && "string" != typeof k[0] && "object" != typeof k[0];) k.shift();
                if (k.length) {
                    if (!_(y)) throw "No collector configured";
                    if (b = !0, h && !S) {
                        var e = R(h, !1, n);
                        return S = !0, e.timeout = l, e.onreadystatechange = function() {
                            4 === e.readyState && U()
                        }, void e.send()
                    }
                    if (O) {
                        var r, o, i = void 0;
                        B(k) ? (r = R(i = y, !0, n), o = function(n) {
                            for (var e = 0, t = 0; e < n.length && !((t += n[e].bytes) >= a);) e += 1;
                            return e
                        }(k)) : (i = z(k[0]), r = R(i, !1, n), o = 1);
                        var c = setTimeout((function() {
                                r.abort(), b = !1
                            }), l),
                            u = function(n) {
                                for (var e = 0; e < n; e++) k.shift();
                        ...
                        if (r.onreadystatechange = function() {
                                var n;
                                4 === r.readyState && r.status >= 200 && (clearTimeout(c), r.status < 300 ? v(o) : (!((n = r.status) >= 200 && n < 300 || !g.includes(n) && m.includes(n)) || (d.error("Status ".concat(r.status, ", will not retry.")), u(o)), b = !1))
                            }, B(k)) {
                            var p = k.slice(0, o);
                            if (p.length > 0) {
                                var w = !1,
                        ...
                        var I = new Image(1, 1),
                            A = !0;
                        I.onload = function() {
                            A && (A = !1, k.shift(), t && D(P, JSON.stringify(k.slice(0, s))), U())
                        }, I.onerror = function() {
                            A && (A = !1, b = !1)
                        }, I.src = z(k[0]), setTimeout((function() {
                            A && b && (A = !1, U())
                        }), l)
                    }
                } else b = !1
            ...
            function R(n, e, t) {
                ...
                for (var o in e ? (r.open("POST", n, !t), r.setRequestHeader("Content-Type", "application/json; charset=UTF-8")) : r.open("GET", n, !t), r.withCredentials = p, f && r.setRequestHeader("SP-Anonymous", "*"), v) Object.prototype.hasOwnProperty.call(v, o) && r.setRequestHeader(o, v[o]);
                return r
            }
            ...
            function V(n) {
                for (var e = (new Date).getTime().toString(), t = 0; t < n.length; t++) n[t].stm = e;
                return n
            }
            ...
            return {
                enqueueRequest: function(n, e) {
                    ...
                    if (I) {
                        if ((l = j(n)).bytes >= a) return r(l.bytes, a), void N(l, y);
                        k.push(l)
                    } else {
                        var u = function(n) {
                            var e = "?",
                                ...
                                r = !0;
                            for (var o in n) n.hasOwnProperty(o) && !t.hasOwnProperty(o) && (r ? r = !1 : e += "&", e += encodeURIComponent(o) + "=" + encodeURIComponent(n[o]));
                            for (var i in t) n.hasOwnProperty(i) && t.hasOwnProperty(i) && (e += "&" + i + "=" + encodeURIComponent(n[i]));
                            return e
                        }(n);
                        if (c > 0) {
                            var l, f = L(z(u));
                            if (f >= c) return r(f, c), void(O && N(l = j(n), e + o))
                        }
                        k.push(u)
                    }
                    var v = !1;
                    t && (v = D(P, JSON.stringify(k.slice(0, s)))), b || v && !(k.length >= i) || U()
                },
        ...
        function nn(n, e, t) {
            var r, o, i;
            return "translate.googleusercontent.com" === n ? ("" === t && (t = e), n = M(e = null !== (o = e, "u", r = (i = new RegExp("^(?:https?|ftp)(?::/*(?:[^?]+))([?][^#]+)").exec(o)) && (null == i ? void 0 : i.length) > 1 ? J("u", i[1]) : null) && void 0 !== r ? r : "")) : "cc.bingj.com" !== n && "webcache.googleusercontent.com" !== n || (n = M(e = document.links[0].href)), [n, e, t]
        }
        var en = 0,
            tn = 1,
            rn = 2,
        ...
        function vn(n, e) {
            ...
            yn(n) ? (n[sn] = n[un], n[cn] = n[an], n[on]++) : n[on] = t;
            var o = (0, r.v4)();
            return n[un] = o, n[dn] = 0, n[ln] = "", n[fn] = void 0, o
        }
        ...
        function bn() {
            return {
                viewport: Sn(kn()),
                documentSize: Sn((n = document.documentElement, e = document.body, t = e ? Math.max(e.offsetHeight, e.scrollHeight) : 0, r = Math.max(n.clientWidth, n.offsetWidth, n.scrollWidth), o = Math.max(n.clientHeight, n.offsetHeight, n.scrollHeight, t), isNaN(r) || isNaN(o) ? "" : r + wn + o)),
        ...
        function kn() {
            var n, e;
            if ("innerWidth" in window) n = window.innerWidth, e = window.innerHeight;
            else {
                var t = document.documentElement || document.body;
                n = t.clientWidth, e = t.clientHeight
            }
            ...
            var p = [],
                g = function(t, o, c, s, l, f) {
                    ...
                    var In, An, Pn = function(n) {
                        ...
                        Dn = null !== (h = null === (m = null == f ? void 0 : f.contexts) || void 0 === m ? void 0 : m.browser) && void 0 !== h && h,
                        Bn = null === (w = null === (y = null == f ? void 0 : f.contexts) || void 0 === y ? void 0 : y.webPage) || void 0 === w || w;
                    p.push((In = function(n) {
                        ...
                        beforeTrack: function(n) {
                            ...
                            if (Qn = !!Vn && !!q(Vn), ge || Qn) $e();
                            else {
                                yn(t) ? (Wn = e || "none" == ke ? mn(t) : vn(t), xe = hn(t)) : (new Date).getTime() - Se > 1e3 * he && (xe++, Wn = vn(t, {
                                ...
                                var o = bn(),
                                    i = o.viewport,
                                    a = o.documentSize;
                                n.add("vp", i), n.add("ds", a), n.add("vid", An(xe)), n.add("sid", An(Wn)), n.add("duid", In(function(n) {
                                    return n[tn]
                                }(t))), n.add("uid", In(Yn)), _e(), n.add("refr", Me(Nn || te)), n.add("url", Me(_n || ee));
                                var c = gn(t, ke, be);
                    ...
                    var Nn, _n, Un, Rn, Mn, Vn, zn, Hn, Jn, Fn, Gn, qn, Xn, Wn, Yn, Qn, Zn = function(t) {
                            ...
                            var o = t.base64,
                                ...
                                l = function(n, t, o) {
                                    ...
                                    return {
                                        track: function(n, e, u) {
                                            n.withJsonProcessor(a(s)), n.add("eid", (0, r.v4)()), n.addDict(l);
                                            var f = function(n) {
                                                return null == n ? {
                                                    type: "dtm",
                                            ...
                                            var v = function(n) {
                                                ...
                                                var t = c.getApplicableContexts(n),
                                                    r = [];
                                                return e && e.length && r.push.apply(r, e), t && t.length && r.push.apply(r, t), r
                                            }(n, i.addPluginContexts(e)));
                                            void 0 !== v && n.addJson("cx", "co", v), t.forEach((function(e) {
                                                try {
                                        ...
                                        addPayloadDict: function(n) {
                                            for (var e in n) Object.prototype.hasOwnProperty.call(n, e) && (l[e] = n[e])
                                        },
                                ...
                                f = n(n({}, l), {
                                    addPlugin: function(n) {
                                        var e, t, r = n.plugin;
                                        s.push(r), null === (e = r.logger) || void 0 === e || e.call(r, d), null === (t = r.activateCorePlugin) || void 0 === t || t.call(r, f)
                                    }
                                });
                            return null == s || s.forEach((function(n) {
                                var e, t;
                                null === (e = n.logger) || void 0 === e || e.call(n, d), null === (t = n.activateCorePlugin) || void 0 === t || t.call(n, f)
                            })), f
                        }({
                        ...
                        $n = document.characterSet || document.charset,
                        Kn = nn(window.location.hostname, window.location.href, z()),
                        ne = V(Kn[0]),
                        ee = Kn[1],
                        te = Kn[2],
                        re = null !== (k = f.platform) && void 0 !== k ? k : "web",
                        oe = tt(s),
                        ie = null !== (S = f.postPath) && void 0 !== S ? S : "/com.snowplowanalytics.snowplow/tp2",
                        ae = null !== (x = f.appId) && void 0 !== x ? x : "",
                        ce = document.title,
                        ue = null === (T = f.resetActivityTrackingOnPageView) || void 0 === T || T,
                        se = null !== (C = f.cookieName) && void 0 !== C ? C : "_sp_",
                        le = null !== (O = f.cookieDomain) && void 0 !== O ? O : void 0,
                        fe = "/",
                        de = null !== (I = f.cookieSameSite) && void 0 !== I ? I : "None",
                        ve = null === (A = f.cookieSecure) || void 0 === A || A,
                        pe = navigator.doNotTrack || navigator.msDoNotTrack || window.doNotTrack,
                        ge = void 0 !== f.respectDoNotTrack && f.respectDoNotTrack && ("yes" === pe || "1" === pe),
                        me = null !== (P = f.cookieLifetime) && void 0 !== P ? P : 63072e3,
                        he = null !== (E = f.sessionCookieTimeout) && void 0 !== E ? E : 1800,
                        ye = En(f),
                        we = jn(f),
                        be = Ln(f),
                        ke = Pn(f),
                        Se = (new Date).getTime(),
                        xe = 1,
                        Te = K(t, l, "localStorage" == ke || "cookieAndLocalStorage" == ke, f.eventMethod, ie, null !== (j = f.bufferSize) && void 0 !== j ? j : 1, null !== (_ = f.maxPostBytes) && void 0 !== _ ? _ : 4e4, null !== (X = f.maxGetBytes) && void 0 !== X ? X : 0, null === (W = f.useStm) || void 0 === W || W, null !== ($ = f.maxLocalStorageQueueSize) && void 0 !== $ ? $ : 1e3, null !== (wn = f.connectionTimeout) && void 0 !== wn ? wn : 5e3, we, null !== (kn = f.customHeaders) && void 0 !== kn ? kn : {}, null === (Sn = f.withCredentials) || void 0 === Sn || Sn, null !== (xn = f.retryStatusCodes) && void 0 !== xn ? xn : [], (null !== (Tn = f.dontRetryStatusCodes) && void 0 !== Tn ? Tn : []).concat([400, 401, 403, 410, 422]), f.idService),
                        Ce = !1,
                        Oe = !1,
                        Ie = {
                            enabled: !1,
                        ...
                        Ae = null !== (On = null === (Cn = f.contexts) || void 0 === Cn ? void 0 : Cn.session) && void 0 !== On && On,
                        Pe = f.onSessionUpdateCallback,
                        Ee = !1;
                    f.hasOwnProperty("discoverRootDomain") && f.discoverRootDomain && (le = function(n, e) {
                        for (var t = window.location.hostname, r = "_sp_root_domain_test_", o = r + (new Date).getTime(), i = "_test_value_" + (new Date).getTime(), a = t.split("."), c = a.length - 2; c >= 0; c--) {
                            ...
                            if (q(o, i, 0, "/", u, n, e), q(o) === i) {
                                F(o, u, n, e);
                                for (var s = G(r), l = 0; l < s.length; l++) F(s[l], u, n, e);
                                return u
                            }
                        }
                        return t
                    ...
                    function _e() {
                        (Kn = nn(window.location.hostname, window.location.href, z()))[1] !== ee && (te = z(ee)), ne = V(Kn[0]), ee = Kn[1]
                    }
                    ...
                    function Re(n) {
                        for (var e = 0; e < document.links.length; e++) {
                            ...
                            !t.spDecorationEnabled && n(t) && (H(t, "click", Ue, !0), H(t, "mousedown", Ue, !0), t.spDecorationEnabled = !0)
                        }
                    }

                    function Me(n) {
                        var e;
                        return Rn && (e = new RegExp("#.*"), n = n.replace(e, "")), Mn && (e = new RegExp("[{}]", "g"), n = n.replace(e, "")), n
                    }
                    ...
                    function He(n) {
                        ...
                        return "localStorage" == ke ? function(n) {
                            try {
                                ...
                                return null === t || +t > Date.now() ? e.getItem(n) : (e.removeItem(n), void e.removeItem(n + ".expires"))
                            } catch (n) {
                                return
                            }
                    ...
                    function Ze(n, e, t) {
                        return !(be && !ye) && ("localStorage" == ke ? D(n, e, t) : ("cookie" == ke || "cookieAndLocalStorage" == ke) && (q(n, e, t, fe, le, de, ve), -1 !== document.cookie.indexOf("".concat(n, "="))))
                    }

                    function $e(n) {
                        var e = ze("id"),
                            t = ze("ses");
                        B(e), B(t), F(e, le, de, ve), F(t, le, de, ve), (null == n ? void 0 : n.preserveSession) || (Wn = (0, r.v4)(), xe = 1), (null == n ? void 0 : n.preserveUser) || (Xn = be ? "" : (0, r.v4)(), Yn = null)
                    }

                    function Ke(n) {
                        n && n.stateStorageStrategy && (f.stateStorageStrategy = n.stateStorageStrategy, ke = Pn(f)), be = Ln(f), ye = En(f), we = jn(f), Te.setUseLocalStorage("localStorage" == ke || "cookieAndLocalStorage" == ke), Te.setAnonymousTracking(we)
                    }
                    ...
                    function nt() {
                        if (!be || ye) {
                            ...
                            Xn = function(n, e) {
                                var t;
                                return n[tn] ? t = n[tn] : e ? (t = "", n[tn] = t) : (t = (0, r.v4)(), n[tn] = t), t
                            }(e, be), Wn = n ? mn(e) : vn(e), xe = hn(e), "none" != ke && (Ye(), pn(e), Qe(e))
                        }
                    }
                    ...
                    function et() {
                        return "none" == ke ? ["1", "", 0, 0, 0, void 0, "", "", "", void 0, 0] : function(n, e, t, o) {
                            var i, a = new Date,
                                c = Math.round(a.getTime() / 1e3);
                            n ? (i = n.split(".")).unshift("0") : i = ["1", e, c, o, c, "", t], i[un] && "undefined" !== i[un] || (i[un] = (0, r.v4)()), i[sn] && "undefined" !== i[sn] || (i[sn] = ""), i[ln] && "undefined" !== i[ln] || (i[ln] = ""), i[fn] && "undefined" !== i[fn] || (i[fn] = ""), i[dn] && "undefined" !== i[dn] || (i[dn] = 0);
                            var u = function(n, e) {
                                    var t = parseInt(n);
                                    return isNaN(t) ? e : t
                                },
                    ...
                    function rt() {
                        Ce && null != l.pageViewId || (l.pageViewId = (0, r.v4)())
                    }

                    function ot() {
                        return null == l.pageViewId && (l.pageViewId = (0, r.v4)()), l.pageViewId
                    }

                    function it() {
                        if ("none" === ke || be || !Bn) return null;
                        var n = "_sp_tab_id",
                            e = N(n);
                        return e || (function(n, e) {
                            try {
                                return window.sessionStorage.setItem(n, e), !0
                            } catch (n) {
                                return !1
                            }
                        }(n, (0, r.v4)()), e = N(n)), e || null
                    }
                    ...
                    function ct(n, e, t) {
                        ...
                        0 === n.configMinimumVisitLength ? n.activityInterval = window.setInterval(o, n.configHeartBeatTimer) : n.activityInterval = window.setTimeout((function() {
                            var i = new Date;
                            zn + n.configMinimumVisitLength > i.getTime() && r(n.callback, at(e, t)), n.activityInterval = window.setInterval(o, n.configHeartBeatTimer)
                    ...
                    function st(n) {
                        var e = n.context,
                            ...
                            a = n.maxYOffset,
                            c = document.title;
                        c !== ce && (ce = c, Un = void 0), Zn.track(function(n) {
                            var e = n.pageUrl,
                                t = n.pageTitle,
                                r = n.referrer,
                                o = n.minXOffset,
                                ...
                                u = n.maxYOffset,
                                s = i();
                            return s.add("e", "pp"), s.add("url", e), s.add("page", t), s.add("refr", r), o && !isNaN(Number(o)) && s.add("pp_mix", o.toString()), a && !isNaN(Number(a)) && s.add("pp_max", a.toString()), c && !isNaN(Number(c)) && s.add("pp_miy", c.toString()), u && !isNaN(Number(u)) && s.add("pp_may", u.toString()), s
                        }({
                            pageUrl: Me(_n || ee),
                            pageTitle: R(Un || ce),
                            referrer: Me(Nn || te),
                    ...
                    function lt(n) {
                        ...
                        0 === (null == e ? void 0 : e.configMinimumVisitLength) ? window.clearTimeout(null == e ? void 0 : e.activityInterval) : window.clearInterval(null == e ? void 0 : e.activityInterval), Ie.configurations[n] = void 0
                    }
                    Zn.setTrackerVersion(c), Zn.setTrackerNamespace(o), Zn.setAppId(ae), Zn.setPlatform(re), Zn.addPayloadPair("cookie", Ne ? "1" : "0"), Zn.addPayloadPair("cs", $n), Zn.addPayloadPair("lang", Le), Zn.addPayloadPair("res", De), Zn.addPayloadPair("cd", Be), Je(), nt(), f.crossDomainLinker && Re(f.crossDomainLinker);
                    var ft = {
                        ...
                        newSession: function() {
                            var n = et();
                            if (yn(n) ? (Wn = "none" != ke ? vn(n) : mn(n), xe = hn(n)) : (xe++, Wn = vn(n, {
                                    memorizedVisitCount: xe
                                })), pn(n), "none" != ke) {
                                var e = gn(n, ke, be);
                                Qe(n), Ye() && Pe && (Ee = !0, Pe(e))
                            }
                            Se = (new Date).getTime()
                        },
                        ...
                        setCustomUrl: function(n) {
                            _e(), _n = function(n, e) {
                                var t;
                                return Ve(e) ? e : "/" === e.slice(0, 1) ? Ve(n) + "://" + M(n) + e : ((t = (n = Me(n)).indexOf("?")) >= 0 && (n = n.slice(0, t)), (t = n.lastIndexOf("/")) !== n.length - 1 && (n = n.slice(0, t + 1)), n + e)
                            }(ee, n)
                        },
                        setDocumentTitle: function(n) {
                            ce = document.title, Un = n
                        },
                        ...
                        enableActivityTracking: function(e) {
                            Ie.configurations.pagePing || (Ie.enabled = !0, Ie.configurations.pagePing = ut(n(n({}, e), {
                                callback: st
                            })))
                        },
                        enableActivityTrackingCallback: function(n) {
                            Ie.configurations.callback || (Ie.enabled = !0, Ie.configurations.callback = ut(n))
                        },
                        ...
                        setCollectorUrl: function(n) {
                            oe = tt(n), Te.setCollectorUrl(oe)
                        },
                        setBufferSize: function(n) {
                            Te.setBufferSize(n)
                        },
                        flushBuffer: function(n) {
                            void 0 === n && (n = {}), Te.executeQueue(), n.newBufferSize && Te.setBufferSize(n.newBufferSize)
                        },
                            ...
                            void 0 === n && (n = {}),
                                function(n) {
                                    var e = n.title,
                                        ...
                                        r = n.timestamp,
                                        o = n.contextCallback;
                                    _e(), Oe && rt(), Oe = !0, ce = document.title;
                                    var a = R((Un = e) || ce);
                                    Zn.track(function(n) {
                                        var e = n.pageUrl,
                                            t = n.pageTitle,
                                            r = n.referrer,
                                            o = i();
                                        return o.add("e", "pv"), o.add("url", e), o.add("page", t), o.add("refr", r), o
                                    }({
                                        pageUrl: Me(_n || ee),
                                        pageTitle: a,
                                        referrer: Me(Nn || te)
                                    ...
                                    if (Ie.enabled && !Ie.installed) {
                                            ...
                                            update: function() {
                                                if ("undefined" != typeof window && "function" == typeof window.addEventListener) {
                                                    var n = !1,
                                                        ...
                                                        t = function() {};
                                                    window.addEventListener("testPassiveEventSupport", t, e), window.removeEventListener("testPassiveEventSupport", t, e), s.hasSupport = n
                                                }
                                            }
                                        };
                                        s.update();
                                        ...
                                        ["click", "mouseup", "mousedown", "mousemove", "keypress", "keydown", "keyup", "touchend", "touchstart"].forEach(f(document)), ["resize", "focus", "blur"].forEach(f(window)), f(window, Ge)("scroll")
                                    }
                                    if (Ie.enabled && (ue || u)) {
                                        zn = c.getTime();
                                        var d = void 0;
                                        for (d in Ie.configurations) {
                                            ...
                                            v && (window.clearInterval(v.activityInterval), ct(v, t, o))
                                        }
                                    }
                                }(n)
                        },
                        ...
                        disableAnonymousTracking: function(n) {
                            f.anonymousTracking = !1, Ke(n), nt(), Te.executeQueue()
                        },
                        enableAnonymousTracking: function(n) {
                            var e;
                            f.anonymousTracking = null === (e = n && (null == n ? void 0 : n.options)) || void 0 === e || e, Ke(n), ye || rt()
                        },
                        clearUserData: $e
                    };
                    return n(n({}, ft), {
                ...
                m = n(n({}, g), {
                    addPlugin: function(n) {
                        var e, t;
                        m.core.addPlugin(n), null === (t = (e = n.plugin).activateBrowserPlugin) || void 0 === t || t.call(e, m)
                    }
                });
        ...
        function Cn(n, e) {
            try {
                (t = null != n ? n : Object.keys(Tn), On(t, Tn)).forEach(e)
            } catch (n) {
        ...
        var Pn = "undefined" != typeof window ? function() {
            ...
            }), !1), H(t, "beforeunload", (function() {
                n.bufferFlushers.forEach((function(n) {
                    n(!1)
                }))
            }), !1), "loading" === document.readyState ? (e.addEventListener ? e.addEventListener("DOMContentLoaded", (function n() {
                e.removeEventListener("DOMContentLoaded", n, !1), r()
            })) : e.attachEvent && e.attachEvent("onreadystatechange", (function n() {
                "complete" === e.readyState && (e.detachEvent("onreadystatechange", n), r())
            })), H(t, "load", r, !1)) : r(), n
        }() : void 0;
        var En = {},
            jn = {};
        ...
        function Ln(n, e) {
            void 0 === n && (n = {}), void 0 === e && (e = Object.keys(En)), e.forEach((function(e) {
                En[e] && (En[e].sharedState.hasLoaded ? (_n(n, e), Un(e)) : En[e].sharedState.registeredOnLoadHandlers.push((function() {
                    _n(n, e), Un(e)
                })))
            }))
        }
        ...
        function Bn(n, e, t) {
            for (var r, o, i, a, c, u; null !== (r = e.parentElement) && null != r && "A" !== (o = e.tagName.toUpperCase()) && "AREA" !== o;) e = r;
            var s = e;
            if (null != s.href) {
                var l = s.hostname || M(s.href),
                    f = l.toLowerCase(),
                    d = s.href.replace(l, f);
                new RegExp("^(javascript|vbscript|jscript|mocha|livescript|ecmascript|mailto):", "i").test(d) || (i = s.id, a = W(s), c = s.target, u = jn[n.id].linkTrackingContent ? s.innerHTML : void 0, d = unescape(d), n.core.track(P({
                    targetUrl: d,
                    elementId: i,
                    elementClasses: a,
                    elementTarget: c,
        ...
        function Nn(n, e) {
            return function(t) {
                var r, o;
                r = (t = t || window.event).which || t.button, o = t.target || t.srcElement, "click" === t.type ? o && Bn(En[n], o, e) : "mousedown" === t.type ? 1 !== r && 2 !== r || !o ? jn[n].lastButton = jn[n].lastTarget = null : (jn[n].lastButton = r, jn[n].lastTarget = o) : "mouseup" === t.type && (r === jn[n].lastButton && o === jn[n].lastTarget && Bn(En[n], o, e), jn[n].lastButton = jn[n].lastTarget = null)
            }
        }
        ...
        function Un(n) {
            ...
            for (r = 0; r < a.length; r++)(null === (t = (e = jn[n]).linkTrackingFilter) || void 0 === t ? void 0 : t.call(e, a[r])) && !a[r][n] && (o = n, i = a[r], jn[o].linkTrackingPseudoClicks ? (H(i, "mouseup", Nn(o, jn[o].linkTrackingContext), !1), H(i, "mousedown", Nn(o, jn[o].linkTrackingContext), !1)) : H(i, "click", Nn(o, jn[o].linkTrackingContext), !1), a[r][n] = !0)
        }
        if (window.ubSnowplowInitialized) console.log("Tracker already initialized.");
        else {
            const n = "ubso",
                e = () => {
                    window.ub.consent && window.ub.consent.addEventListener("change", (e => {
                        !0 === e.detail.new.statistics ? (An(""), document.cookie = `${n}=; path=/; SameSite=Lax; Max-Age=0;`) : (An(n), document.cookie = `${n}=1; path=/; SameSite=Lax;`)
                    }))
                },
                t = (() => {
            ...
            (() => {
                ...
                var c, u, s, l, f;
                o.id && (t() || o.id !== o.currentId) && (s = "sp-ub", l = `${document.location.hostname}/_ub`, void 0 === (f = {
                    appId: "landing_page",
                    platform: "web",
                    eventMethod: "beacon",
                    postPath: "/i",
                ...
                }) && (f = {}), Pn && function(n, e, t, r, o, i) {
                    Tn.hasOwnProperty(n) || (Tn[n] = xn(n, e, t, r, o, i), Tn[n])
                }(s, s, "js-".concat("3.15.0"), l, Pn, f), c = n.visitorId, Cn(undefined, (function(n) {
                    n.setUserId(c)
                })), t() && (u = {
                    context: [a("visit")]
                    ...
                    let u;
                    u = "boolean" == typeof c ? c ? [a("link-click", ["conversion"])] : [a("link-click")] : c, "trackLinkClick" !== n ? console.log("Unsupported event type.") : Dn({
                        targetUrl: e,
                        elementId: t,
                        elementClasses: r,
                        elementTarget: o,
                ...
                }, e(), window.ubSnowplowInitialized = !0)
            })()
        }
    }()
}();